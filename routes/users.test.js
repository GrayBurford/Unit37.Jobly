...
describe("POST /users", function () {
  test("works: create non-admin user", async function () {
  ...
  test("works: create admin user", async function () {
    const resp = await request(app)
        .post("/users")
        .send({
          username: "u-new",
  ...
  test("Fails: unauth for anon/non-admin user", async function () {
    const resp = await request(app)
        .post("/users")
        .send({
          username: "u-new",
  ...
  test("bad request (400) if missing data", async function () {
    const resp = await request(app)
        .post("/users")
        .send({
          username: "u-new",
  ...
  test("bad request (400) if invalid data", async function () {
    const resp = await request(app)
        .post("/users")
        .send({
          username: "u-new",
...
describe("PATCH /users/:username", () => {
  ...
  test("works as correct user: set new password", async function () {
    const resp = await request(app)
        .patch(`/users/u1`)
        .send({
  ...
  test("works as admin: set new password", async function () {
    const resp = await request(app)
        .patch(`/users/u1`)
        .send({
          password: "new-password",
